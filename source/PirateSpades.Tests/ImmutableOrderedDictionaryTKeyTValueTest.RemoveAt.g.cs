// <copyright file="ImmutableOrderedDictionaryTKeyTValueTest.RemoveAt.g.cs">Copyright ©  2011</copyright>
// <auto-generated>
...
public void RemoveAtThrowsContractException853()
{
    try
    {
      ...
      this.RemoveAt<int, int>(immutableOrderedDictionary, 1);
      throw 
...
[PexGeneratedBy(typeof(ImmutableOrderedDictionaryTKeyTValueTest))]
[PexRaisedContractException(PexExceptionState.Expected)]
public void RemoveAtThrowsContractException571()
{
    try
    {
      OrderedDictionary<int, int> orderedDictionary;
      ...
      immutableOrderedDictionary =
        new ImmutableOrderedDictionary<int, int>(orderedDictionary);
      this.RemoveAt<int, int>(immutableOrderedDictionary, 0);
      throw 
        new AssertFailedException("expected an exception of type ContractException");
    }
    catch(Exception ex)

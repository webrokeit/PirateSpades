// <copyright file="ImmutableOrderedDictionaryTKeyTValueTest.Add01.g.cs">Copyright ©  2011</copyright>
// <auto-generated>
...
public void Add01ThrowsContractException894()
{
    try
    {
      ...
      this.Add01<int, int>(immutableOrderedDictionary, 0, 0);
      throw 
...
[PexGeneratedBy(typeof(ImmutableOrderedDictionaryTKeyTValueTest))]
[PexRaisedContractException(PexExceptionState.Expected)]
public void AddThrowsContractException56()
{
    try
    {
      OrderedDictionary<int, int> orderedDictionary;
      ...
      this.Add<int, int>(immutableOrderedDictionary, s0, (object)null);
      throw 
        new AssertFailedException("expected an exception of type ContractException");
    }
    catch(Exception ex)
...
[PexGeneratedBy(typeof(ImmutableOrderedDictionaryTKeyTValueTest))]
[PexRaisedContractException(PexExceptionState.Expected)]
public void AddThrowsContractException576()
{
    try
    {
      OrderedDictionary<int, int> orderedDictionary;
      ...
      immutableOrderedDictionary =
        new ImmutableOrderedDictionary<int, int>(orderedDictionary);
      this.Add<int, int>(immutableOrderedDictionary, (object)null, (object)null);
      throw 
        new AssertFailedException("expected an exception of type ContractException");
    }
    catch(Exception ex)

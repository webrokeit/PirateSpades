...
public void GetPlayerBets299()
{
    PirateMessage pirateMessage;
    Dictionary<string, int> dictionary;
    pirateMessage = new PirateMessage(PirateMessageHead.Fail, "player_bet: a;10");
...
[TestMethod]
[PexGeneratedBy(typeof(PirateMessageTest))]
public void GetPlayerBets760()
{
    PirateMessage pirateMessage;
    Dictionary<string, int> dictionary;
    pirateMessage = new PirateMessage(PirateMessageHead.Fail, "player_bet: a;00");
    dictionary = this.GetPlayerBets(pirateMessage);
    Assert.IsNotNull((object)dictionary);
    Assert.IsNotNull(dictionary.Comparer);
...
[TestMethod]
[PexGeneratedBy(typeof(PirateMessageTest))]
public void GetPlayerBets75()
{
    PirateMessage pirateMessage;
    Dictionary<string, int> dictionary;
    pirateMessage = new PirateMessage(PirateMessageHead.Fail, "player_bet: AZ");
    dictionary = this.GetPlayerBets(pirateMessage);
    Assert.IsNotNull((object)dictionary);
    Assert.IsNotNull(dictionary.Comparer);
    Assert.AreEqual<int>(0, dictionary.Count);
...
[TestMethod]
[PexGeneratedBy(typeof(PirateMessageTest))]
public void GetPlayerBets671()
{
    PirateMessage pirateMessage;
    Dictionary<string, int> dictionary;
    pirateMessage = new PirateMessage(PirateMessageHead.Fail, "player_bet: A\0");
    dictionary = this.GetPlayerBets(pirateMessage);
    Assert.IsNotNull((object)dictionary);
    Assert.IsNotNull(dictionary.Comparer);
    Assert.AreEqual<int>(0, dictionary.Count);
...
[TestMethod]
[PexGeneratedBy(typeof(PirateMessageTest))]
public void GetPlayerBets815()
{
    PirateMessage pirateMessage;
    Dictionary<string, int> dictionary;
    pirateMessage = new PirateMessage(PirateMessageHead.Fail, "player_bet: Z");
    dictionary = this.GetPlayerBets(pirateMessage);
    Assert.IsNotNull((object)dictionary);
    Assert.IsNotNull(dictionary.Comparer);
    Assert.AreEqual<int>(0, dictionary.Count);
...
public void GetPlayerBetsThrowsContractException55()
{
    try
    {
      Dictionary<string, int> dictionary;
